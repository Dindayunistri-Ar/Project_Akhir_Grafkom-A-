...
def on_click(button, state, x, y):
    global mode, nyawa, restart, pos_x, pos_y
    if mode == 0:
        ...
        if button == GLUT_LEFT_BUTTON and state == GLUT_DOWN:
            if (x >= 333 and x <= 402) and (y >= 275 and y <= 303):
                ...
                restart = 0
            print("Klik Kiri ditekan ", "(", x, ",", y, ")")
            print(f'nyawa {nyawa} | mode {mode} | restart {restart}')


def display():
    global mode, nyawa, pos_x, pos_y, restart, text, nyawa, over
    ...
    if mode == 0:
        ...
        if mode == 4 and (pos_x == 1550 and pos_y == 1400):
            text = False
