...
def shape_nyawa(scene_nyawa):
    ...
    if scene_nyawa == 3:
        ...
        glVertex2f(1250, 1700)
        glVertex2f(1250, 1600)
        glVertex2f(1150, 1600)
        glEnd()

        glColor3ub(255, 0, 0)
        glBegin(GL_POLYGON)
        glVertex2f(1300, 1700)
        glVertex2f(1400, 1700)
        ...
        glColor3ub(255, 0, 0)
        glBegin(GL_POLYGON)
        glVertex2f(1450, 1700)
        glVertex2f(1550, 1700)
        ...
        if nyawa == 0 and restart != 1:
            text = False
            drawBitmapText("GAME OVER!", 550, 1000, 0)
...
def display():
    global mode, nyawa, pos_x, pos_y, restart, text, nyawa
...
def input_keyboard(key, x, y):
    global pos_x, pos_y, nyawa, text, restart, mode
